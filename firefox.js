...
browser.runtime.onMessage.addListener(
    function (msg, sender, sendResponse) {
        ...
        if (msg.tab_type == "youtube") {
            ...
            sendResponse(data);
        } else if (msg.tab_type == "niconico") {
            data = parse_niconico();
            console.log('returning niconico page data', data);
            sendResponse(data);
        } else {
            console.log('what')
...
function parse_niconico() {
    song_name = $('.VideoTitle').text();
    artist_name = $('.VideoOwnerInfo-pageLink').text();
    return { song_name: song_name, artist_name: artist_name }
}